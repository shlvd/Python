...
API_KEY = 'AIzaSyBlK7HZuWQe7lXNPEym8jqY__k1-2Hv_VI' # replace with your own Google Maps API key
...
try:
    ...
    for i in range(len(macs)):
        wifi_list.append({'macAddress': macs[i],
                          'signalStrength': str(int(signals[i][0]) / 2 - 100),  # convert signal strength to RSSI dBm
